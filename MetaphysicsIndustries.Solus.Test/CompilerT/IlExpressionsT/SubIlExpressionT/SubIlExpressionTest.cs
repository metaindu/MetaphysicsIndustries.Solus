...
namespace MetaphysicsIndustries.Solus.Test.CompilerT.IlExpressionsT.SubIlExpressionT
{
    [TestFixture]
    public class SubIlExpressionTest
    {
        [Test]
        public void ConstructorCreatesInstance()
        {
            ...
            // when
            var result = new SubIlExpression(left, right);
            // then
