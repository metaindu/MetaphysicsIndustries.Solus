...
namespace MetaphysicsIndustries.Solus.Test.CompilerT.IlExpressionsT.NegIlExpressionT
{
    [TestFixture]
    public class NegIlExpressionTest
    {
        [Test]
        public void ConstructorCreatesInstance()
        {
            ...
            // when
            var result = new NegIlExpression(argument);
            // then
