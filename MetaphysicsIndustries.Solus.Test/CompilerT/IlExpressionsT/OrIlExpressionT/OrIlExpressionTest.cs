...
namespace MetaphysicsIndustries.Solus.Test.CompilerT.IlExpressionsT.OrIlExpressionT
{
    [TestFixture]
    public class OrIlExpressionTest
    {
        [Test]
        public void ConstructorCreatesInstance()
        {
            ...
            // when
            var result = new OrIlExpression(left, right);
            // then
